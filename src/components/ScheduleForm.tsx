          ...
          <CardContent className="p-6 space-y-6">
            ...
            <div className="space-y-4">
              ...
              <div className="grid grid-cols-2 md:grid-cols-4 lg:grid-cols-7 gap-3">
                {DAYS_OF_WEEK.map(day => <div key={day.key} className="bg-gray-50 border border-gray-200 rounded-xl p-3 hover:bg-blue-50 hover:border-blue-200 transition-colors px-[9px]">
